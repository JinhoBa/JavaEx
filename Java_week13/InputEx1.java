...
public class InputEx1 extends JFrame{
	...
	public void createGUI() {
		...
		rbName = new JRadioButton("이름", true);
		rbDept = new JRadioButton("학과", true);
	...
	public void dbUpdate() {
		try {
			...
			stmt.executeUpdate("update student set dept = '"+in_dept+"', name = '"+in_name+"' where id = '"+in_id+"'");
	...
	public void dbInsert() {
		try {
			...
			String in_name = tfName.getText().toString();
			String in_dept = tfDept.getText().toString();
			String sql = "insert into student(id,name,dept)value(?,?,?);";
	...
	public void dbDelete() {
		try {
			...
			stmt = conn.createStatement();
			String in_id = tfId.getText().toString();
			stmt.executeUpdate("delete from student where id = '"+in_id+"';");
			System.out.println(in_id+"삭제완료");
			tfId.setText("");
			tfName.setText("");
			tfDept.setText("");
			stmt.close();
